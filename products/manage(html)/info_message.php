                    ...
                    <table class="result-tab" width="100%">
                        ...
                        foreach ($result as $item): ?>
                            <tr>
                                ...
                                <td><?php echo $item['m_user']; ?></td>
                                <td><?php echo $item['m_status']; ?></td>
                                <td><?php echo $item['m_answer']; ?></td>
                                <td><?php echo $item['m_reply1']; ?></td>
                                <td><?php echo $item['m_reply2']; ?></td>
                                <td><?php echo $item['m_update']; ?></td>
                                <td>
                                    <input type="button" value="修改" class="btn btn-primary btn2" onclick="editUser(<?php echo $item['m_id'];?>)">

                                    <input type="button" value="删除" class="btn btn-primary btn2"  onclick="delUser(<?php echo $item['m_id'];?>)">
