...
if(isset($_REQUEST['pro'])){
    ...
    if(getResultNum($link,$sql)){
        ...
        alertMes("没有找到所要信息",'../manage/system_people.php');
    }
}
$pageSize =10;
            ...
            <ul class="side-list">
                ...
                <li>
                    ...
                    <ul class="sid-menu">
                        ...
                        <li class="on"><a href="system_people.php"><i class="icon-fonts">&#xe904; </i>用户管理</a></li>
            ...
            <div class="search-wrap">
                <div class="search-content">
                    ...
                    <table class="search-tab">
                        <tr>
                            <form action="../manage/system_people.php?att=u_id" method="post">
                                <th width="70">用户id:</th>
                            ...
                            <form action="../manage/system_people.php?att=u_name" method="post">
                                <th width="70">用户名称:</th>
            ...
            <div class="result-content">
                ...
                <div class="content-title">
                    <div class="result-list">
                        <a href="add_people.php"><i class="icon-fonts iconn-style"> &#xe914;</i>新增管理员 </a>
                            ...
                            <tr>
                                ...
                                <td>
                                        <input type="button" value="修改" class="btn btn-primary btn2"
                                               onclick="window.location = 'change_people.php?id=<?= $item['u_id'] ?>'">


                                        <input type="button" value="删除" class="btn btn-primary btn2"
                                               onclick="if(window.confirm('确定要删除吗？')){window.location='../admin/addadminaction.php?act=delPeople&id=<?= $item['u_id'] ?>';}else{ window.location='system_people.php'; }">
