    ...
    <div class="main-wrap">
        <div class="main-top">
            <div class="main-top-list">
                ...
                <span class="crumb-step">></span>
                <span class="crumb-name">更改商品</span>
            </div>
        ...
        <div class="main-content">
            <div class="result-content">
                <form action="../admin/addadminaction.php?act=editPro&id=<?=$id?>" method="post" >
                    <table  class="insert-tab"  width="100%">
                        ...
                        <tr>
                            ...
                            <td><input placeholder="<?php echo $row['prod_name'];?>" class="common-text" name="prod_name" size="50" type="text"></td>
                        </tr>
                        <tr>
                            <th><i class="require-red">*</i>商品售价：</th>
                            <td><input placeholder="<?php echo $row['prod_sale'];?>" class="common-text" name="prod_sale" size="50" type="text"></td>
                        </tr>
                        <tr>
                            <th><i class="require-red">*</i>商品成本：</th>
                            <td><input placeholder="<?php echo $row['prod_cost'];?>" class="common-text" name="prod_cost" size="50"  type="text"></td>
                        </tr>
                        <tr>
                            <th><i class="require-red">*</i>商品库存：</th>
                            <td><input placeholder="<?php echo $row['prod_num'];?>" class="common-text" name="prod_num" size="50" type="text"></td>
                        </tr>
                        <tr>
                            <th width="120"><i class="require-red"></i>分类：</th>
                            <td>
                                <select name="colId"  class="required">
                                    <option value=""><?php echo $row['prod_mold'];?></option>
                        ...
                        <tr>
                            <th>商品说明：</th>
                            <td><textarea placeholder="<?php echo $row['prod_introduce'];?>" name="prod_introduce" class="common-textarea" id="content" cols="30" style="width: 80%;height: auto"></textarea></td>
                        </tr>
                        <tr>
                            <th></th>
                            <td class="td1">
                                <input class="btn btn-primary btn6 mr10" value="更改" type="submit">
                                <i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</i>
