...
<div class="top-wrap">
    <div class="top-inner">
        <div class="top-left">
            <ul class="top-list">
                <li><a class="on" href="../manage(html)/manage_products.php">管理首页</a></li>
        ...
        <div class="top-right">
            <ul class="top-info-list">
                ...
                <li>
                    <a href="../manage/change_user.php?id = <?=$_SESSION['id'];?>">修改密码</a>
                </li>
                <li>
                    <a href="">管理员</a>
                </li>
...
<div class="container-wrap">
    <div class="side-wrap">
        <div class="side-tittle">
            <a href="../manage(html)/manage_products.php"><h1><i class="icon-fonts">&#xe940; </i>菜单</h1></a>
        </div>
            ...
            <ul class="side-list">
                ...
                <li>
                    ...
                    <ul class="sid-menu">
                        ...
                        <li><a href="../manage(html)/info_message.php"><i class="icon-fonts">&#xe909; </i>留言管理</a></li>
    ...
    <div class="main-wrap">
        <div class="main-top">
            <div class="main-top-list">
                ...
                <a href="../manage(html)/manage_products.php">首页</a>
                <span class="crumb-step">></span>
                <span class="crumb-name"><a href="manage_products.php">系统管理</a></span>
                <span class="crumb-step">></span>
                <span class="crumb-name"><a href="system_user.php">人员管理</a></span>
                <span class="crumb-step">></span>
        ...
        <div class="main-content">
            <div class="result-content-u">
                <form action="../admin/addadminaction.php?act=addadmin" method="post" >
                   <ul>
                       <li class="li6">
                           <label><i class="require-red">*</i>用户id：</label>

                           <input class="common-text required"  name="u_id" size="50" value="" type="text">
                       </li>
                       <li>
                       ...
                       <li>
                           <label>&nbsp;用户姓名：</label>
                           <input class="common-text" name="u_name" size="50" type="text">
                       </li>
                       <li>
                           <label><i class="require-red">*</i>联系方式：</label>
                           <input class="common-text" name="u_contact" size="50"  type="text">
                       </li>
                       <li class="li5">
